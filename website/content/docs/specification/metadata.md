...
- <a id="%24defs/Dataset"></a>**`Dataset`** *(object)*
  - <a id="%24defs/Dataset/properties/%24schema"></a>**`$schema`**: Must be: `"https://fairspec.github.io/profiles/0.1.0/dataset.json"`.
...
- <a id="%24defs/Table1Resource"></a>**`Table1Resource`** *(object)*: Data records have to conform to the Table1 schema.
  ...
  - <a id="%24defs/Table1Resource/properties/tableSchema"></a>**`tableSchema`**: Must be: `"https://fairspec.github.io/schemas/0.1.0/table1.json"`.
- <a id="%24defs/Table2Resource"></a>**`Table2Resource`** *(object)*: Data items have to conform to the Table2 schema.
  ...
  - <a id="%24defs/Table2Resource/properties/tableSchema"></a>**`tableSchema`**: Must be: `"https://fairspec.github.io/schemas/0.1.0/table2.json"`.
