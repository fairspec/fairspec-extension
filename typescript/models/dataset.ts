...
export const Table1Resource = z.object({
    ...
    Table: z.literal("https://fairspec.github.io/fairspec-extension/schemas/0.3.0/table1.json")
});

export const Table2Resource = z.object({
    name: z.literal("table2"),
    Table: z.literal("https://fairspec.github.io/fairspec-extension/schemas/0.3.0/table2.json")
});

export const Resource = z.union([Table1Resource, Table2Resource]);

export const Dataset = z.object({
    $schema: z.literal("https://fairspec.github.io/fairspec-extension/profiles/0.3.0/dataset.json"),
